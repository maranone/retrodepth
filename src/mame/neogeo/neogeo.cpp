...
ROM_START( retrodepth ) /* Unlicensed homebrew demo, no official game ID # */
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "900-p1.p1", 0x000000, 0x080000, CRC(4e308647) SHA1(d5b0bb98ca4a3b7621b34349454ff4cf3b31339e) )

	NEO_SFIX_128K( "900-s1.s1", CRC(a738cd54) SHA1(6991b70265cf45c67577d4f362ef3d7cb85adac9) )

	NEO_BIOS_AUDIO_128K( "900-m1.m1", CRC(d28b2968) SHA1(3ec54e63f19340879decc5d8b1b38901b192240d) )

	ROM_REGION( 0x200000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "900-v1.v1", 0x000000, 0x080000, CRC(75660aac) SHA1(6a521e1d2a632c26e53b83d2cc4b0edecfc1e68c) )

	ROM_REGION( 0x200000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "900-c1.c1", 0x000000, 0x100000, CRC(6ffb6b00) SHA1(a98db4387928b66f9f0ba74846e0f07065ec8a29) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "900-c2.c2", 0x000001, 0x100000, CRC(5cf57ada) SHA1(333a7933caf110d0421a5c7c0b8bf6e07108f96d) ) /* Plane 2,3 */
ROM_END
...
GAME( 2026, retrodepth, neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "RetroDepth", "RetroDepth Demo", MACHINE_SUPPORTS_SAVE )
